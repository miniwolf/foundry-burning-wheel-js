...
export class BWCharacterSheet extends BWActorSheet {
    ...
    getData() {
        ...
        for (const value of items) {
            ...
            switch (i.type) {
                ...
                case "skill":
                    const s = i;
                    if (s.system.learning) {
                        learning.push(s);
                    }
                    else if (s.system.training) {
                        training.push(s);
                    }
                    else {
                        skills.push(s);
    ...
    async learnNewSkill(e, actor) {
        ...
        return addNewItem({
            ...
            itemDataMid: (i) => i.system.skilltype.titleCase(),
            baseData: {
                learning: true,
                root1: "perception",
                skilltype: "special",
    ...
    async _manageItems(e) {
        ...
        const action = $(t).system("action");
        const id = $(t).system("id");
        let options;
        switch (action) {
            case "broadcast":
            ...
            case "addTrait":
                return addNewItem({
                    ...
                    itemType: "trait",
                    itemDataLeft: (i) => i.system.restrictions.titleCase(),
                    itemDataMid: (i) => i.system.traittype.titleCase(),
            ...
            case "addSpell":
                return addNewItem({
                    ...
                    itemType: "spell",
                    itemDataLeft: (i) => `Origin: ${i.system.origin.titleCase()}`,
                    itemDataMid: (i) => `Impetus: ${i.system.impetus.titleCase()}`,
                    baseData: {},
