...
export class BWCharacter extends BWActor {
    prepareData() {
        ...
        this.system.successOnlyRolls = (this.system.settings.onlySuccessesCount || '')
            .split(',')
    ...
    async addStatTest(stat, name, accessor, difficultyGroup, isSuccessful, routinesNeeded = false, force = false) {
        ...
        const onlySuccessCounts = this.system.successOnlyRolls.indexOf(name) !== -1;
                ...
                new Dialog({
                    ...
                    buttons: {
                        ...
                        never: {
                            label: "No",
                            callback: () => {
                                this.update({ "system.settings.showBurner": false });
                            }
                        }
                    },
                    default: "yes"
