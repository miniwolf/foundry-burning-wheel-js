...
export class DuelOfWitsDialog extends ExtendedTestDialog {
    constructor(d, o) {
        ...
        this.showV1 = this.showV1 || false;
        this.showV2 = this.showV2 || false;
        this.showV3 = this.showV3 || false;
        this.blindS1 = this.blindS1 || false;
        this.blindS2 = this.blindS2 || false;
        this.topic = "Duel";
        this.settingName = constants.settings.duelData;
    }
    get template() {
    ...
    getData() {
        ...
        data.actor1Skills = (data.actor1?.system.socialSkills || []).map((s) => { return { id: s._id, label: s.name }; });
        data.actor2 = actors.find(a => a.id === data.side2ActorId);
        data.actor2Skills = (data.actor2?.system.socialSkills || []).map((s) => { return { id: s._id, label: s.name }; });
